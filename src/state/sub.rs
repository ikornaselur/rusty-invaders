...
impl State {
    pub fn sub(&mut self, register: Register) -> Option<u8> {
        // 4 cycles
    ...
    pub fn sbb(&mut self, register: Register) -> Option<u8> {
        // 4 cycles
